#!/bin/bash
# ==============================================================================
# VAST Data GCP Master Validator (Combined)
...
#
# EXAMPLES:
#   ./gcp_check_all.sh my-project my-vpc
#   ./gcp_check_all.sh my-project my-vpc subnet-1 "" -v
#   ./gcp_check_all.sh -v   (Will prompt for required inputs interactively)
# ==============================================================================
...
# Get current project ID if empty
...
# ---------------------------------------------------------
# Infrastructure Existence & PGA Check
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# Firewall Ingress (GCP Service CIDRs)
# ---------------------------------------------------------
