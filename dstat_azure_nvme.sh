...
dool_io="dool $dool_io_flags --output $OUTPUTFILE_io $minterval $count"
dool_process="dool $dool_proc_flags --output $OUTPUTFILE_proc $minterval $count"
dool_sys="dool $dool_sys_flags --output $OUTPUTFILE_sys $minterval $count"
...
###-- Main - put the comands into the background
bg_cmd ${dool_process}
bg_cmd ${dool_sys}
bg_cmd ${dool_io}